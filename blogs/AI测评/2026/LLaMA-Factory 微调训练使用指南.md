...
![...](./images/LLaMA-Factory-guide-001.png)
...
![...](./images/LLaMA-Factory-guide-002.jpeg)
...
![...](./images/LLaMA-Factory-guide-003.png)
...
![...](./images/LLaMA-Factory-guide-004.png)
...
![...](./images/LLaMA-Factory-guide-005.png)

由于网络环境等原因，文件下载后往往会存在文件不完整的很多情况，下载后需要先做一下校验，校验分为两部分，第一先检查一下文件大小和文件数量是否正确，和原始的huggingface显示的做一下肉眼对比。

[探秘AI大脑：一个语言模型的文件包里到底有什么？](https://my.feishu.cn/wiki/LmUgwQEWdisKYHkehaScmJMjnKb?from=from_copylink)
...
![...](./images/LLaMA-Factory-guide-007.png)
...
![...](./images/LLaMA-Factory-guide-008.png)

> 本次及后续所有的程序的入口都是 llamafactory-cli，通过不同的参数控制现在是实现什么功能，所有的可选项包括

![...](./images/LLaMA-Factory-guide-009.jpeg)

另外两个关键参数解释如下，后续的基本所有环节都会继续使用这两个参数

![...](./images/LLaMA-Factory-guide-010.jpeg)
...
![...](./images/LLaMA-Factory-guide-011.png)
...
![...](./images/LLaMA-Factory-guide-012.png)
...
![...](./images/LLaMA-Factory-guide-013.jpeg)
...
![...](./images/LLaMA-Factory-guide-014.png)

训练完后就可以在设置的output_dir看到如下内容，主要包含3部分

![...](./images/LLaMA-Factory-guide-015.png)
...
![...](./images/LLaMA-Factory-guide-016.png)
...
![...](./images/LLaMA-Factory-guide-017.png)
...
![...](./images/LLaMA-Factory-guide-018.jpeg)

**点击图片可查看完整电子表格**

![...](./images/LLaMA-Factory-guide-019.png)

![...](./images/LLaMA-Factory-guide-020.png)
...
![...](./images/LLaMA-Factory-guide-021.jpeg)
...
![...](./images/LLaMA-Factory-guide-022.png)
...
![...](./images/LLaMA-Factory-guide-023.png)
...
![...](./images/LLaMA-Factory-guide-028.png)
...
![...](./images/LLaMA-Factory-guide-029.png)
...
![...](./images/LLaMA-Factory-guide-030.png)

- 转换成功。

可在 megred-model-path 新模型的路径下查看gguf文件

![...](./images/LLaMA-Factory-guide-031.png)
...
![...](./images/LLaMA-Factory-guide-032.png)
...
![...](./images/LLaMA-Factory-guide-033.png)
...
![...](./images/LLaMA-Factory-guide-034.png)
