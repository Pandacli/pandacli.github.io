...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.001.jpeg)
...
> **说明在6.0及以后的版本中，DevEco Testing Hypium插件在下载包中的名称由“DevEcoTesting-Hypium”修改为“hypium-pycharm-plugin”。**

![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.002.png)
安装完成后在Plugins界面可以看到DevEcoTesting-Hypium插件。
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.003.png)
- **插件功能**
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.004.png)
**Ⅰ. 项目文件区域**
在项目文件区域右键点击项目目录或者文件，选择 DevEco Testing Hypium，弹出对应的功能菜单。
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.005.png)
功能菜单根据选择的目录和文件不同存在区别，详细参见下表：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.006.jpeg)
**点击图片可查看完整电子表格**

> 生成 DevEco Testing 工具 可用的 测试服务包 ，需要补充以下两个文件。

**setup-regression.py 文件补充**
...
setup(
    #测试服务包名称
    name='hypium-perf-test',
    # 测试服务包版本
    version='1.0.0',
    # 作者
    author='dengjiajun',
    py_modules=['testcases.Example'],  # 指定测试用例文件列表
...
**Ⅱ. 代码编辑区域**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.007.jpeg)
**点击图片可查看完整电子表格**
**Ⅲ. ToolWindow区域**
**UiViewer功能**
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.008.png)
设备信息说明见下表：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.009.jpeg)
**点击图片可查看完整电子表格**
...
**单设备投屏界面**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.010.png)
**功能说明：**
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.011.jpeg)
**点击图片可查看完整电子表格**
**工具区2：**
此工具区提供一系列常用的设备操作功能，便于在投屏过程中快速执行基本控制与调试操作，当前支持的功能见下表：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.012.jpeg)
**点击图片可查看完整电子表格**
**工具区3：**
此工具区提供系统管理相关功能，当前支持的功能见下表：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.013.jpeg)
**点击图片可查看完整电子表格**
**双设备投屏界面**
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.014.png)
**执行结果报告展示功能**
使用“一键执行当前用例”功能完成测试用例执行后，插件将在控制台旁边自动生成执行结果标签。点击该标签，即可查看本次用例执行过程中各步骤的截图。
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.015.png)
**Ⅳ. 设置面板区**
打开PyCharm设置面板，选中左侧的DevEco Testing Hypium选项，可以进入DevEco Testing Hypium的设置面板，如下图所示。
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.016.png)
各个配置项的详细说明见下表：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.017.jpeg)
**点击图片可查看完整电子表格**
**Ⅴ. 工程创建区域**
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.019.png)
...
测试脚本工程创建主要有两种方式：
a）直接使用以下附件中的模板工程。
[HypiumProjectTemplate.zip](https://alliance-communityfile-drcn.dbankcdn.com/FileServer/getFile/cmtyPub/011/111/111/0000000000011111111.20260428202149.86767420690067113494768043790742:20260509104424:2800:2B76CC11AB36DEA704E75A982BB1CCD32CA342DB7153C3A1B41A5AE5A48DD4FB.zip?needInitFileName=true)
...
**单个测试用例模式**
**测试用例脚本文件(Example.py)**
该文件包含测试用例的执行逻辑，核心为三个关键的生命周期函数：setup、process、teardown。
在用例开发时，用户需要根据业务需求在对应的函数中编写测试逻辑代码。生命周期函数的详细说明见下表：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.021.jpeg)
**点击图片可查看完整电子表格**
**示例代码**
...
**测试套模式**
**测试套脚本文件( 默认为 Ts_001.py)**
该文件包含测试套的初始化和清理逻辑，核心为两个关键的生命周期函数：setup、teardown。在用例开发时，用户需要根据业务需求在对应的函数中编写测试逻辑代码。
生命周期函数的详细说明见下表：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.022.jpeg)
**点击图片可查看完整电子表格**
...
> 则 该测试套件 执行的最终 顺序为：
>
> Ts_001.py 的setup() -> TC_001.py 的setup() -> TC_001.py 的process() -> TC_001.py 的teardown() —> TC_002.py 的setup() -> TC_002.py 的process() -> TC_002的 teardown()

其实多测试用例区别不大，只需要在新建文件的时候选择Hypium TestSuite就可以自动帮我们生成多测试用例可执行的文件
- 在testcase 目录创建 测试套件
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.023.png)
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.024.png)
...
默认可以什么都不配置，但是Ts_002.py要和json名称一样，进入Ts_002.py文件**示例代码**

```python
from devicetest.core.suite.test_suite import TestSuite
from devicetest.core.test_case import Step, CheckPoint
from hypium import UiDriver, BY

class Ts_002(TestSuite):

    def __init__(self, configs, path):
        super().__init__(configs, path)
        self.driver = None
    ...
    def setup(self):
        ...
        #打开传祺App应用
        Step("1.打开传祺App")
        self.driver.start_app(package_name="com.cloudy.component.hos",page_name="EntryAbility")
        #点击“本次使用允许”的text
        #touch=self.driver.touch(BY.text("本次使用允许"))
    ...
    def teardown(self):
        print("测试结束")
        #停止应用
        self.driver.stop_app(package_name="com.cloudy.component.hos",wait_time=3)
        #Step("收尾工作:xxxx")
        # *todo*
```

可以看到两个熟悉的函数，没错，就是整个测试过程中的周期函数，开始和结束都会执行，
**测试套配置 JSON 文件( 框架默认为 Ts_002.json)**
...
```json
{
    ...
    "driver": {
        ...
        //方式二，测试用例的py文件放在testsuite文件夹中，并且命名以"TC_"开头，框架即可自动扫描所有用例并执行
    },
...
**测试用例脚本文件（TC_001.py ； TC_002.py）**
此处介绍测试用例脚本文件和测试套关联的两种方式：
**方式一：** 在测试套配置文件中指定所有的测试用例脚本文件路径
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.025.png)
...
run常用指令基本使用方式如下：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.026.jpeg)
**点击图片可查看完整电子表格**
**PyCharm中用例执行**
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.028.jpeg)
**点击图片可查看完整电子表格**
...
BY选择器支持的所有属性如下表所示：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.029.jpeg)
**点击图片可查看完整电子表格**
**多属性组合定位控件**
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.030.jpeg)
**点击图片可查看完整电子表格**
**注意：** 相对位置中的“前后”关系，对应控件树的前序遍历顺序（即深度优先遍历中根-子节点的访问次序），用户可以在 UiViewer 的可视化控件树中直观查看该顺序：控件在列表中从上到下的排列顺序，即为其在相对定位中的从前到后顺序。
相对位置通常和控件的属性结合使用来定位控件。
以下图场景为例，界面上存在多个按钮，用户需要点击显示通知图标之后的按钮，定位方式如下：
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.031.png)
...
> 注意
>
> XPath不能和其他属性匹配一起使用，通过XPath查找控件相比 单属性 和多属性查找控件的效率会有所下降。
>
> 多属性 > 单属性 > Xpath

在如下场景中，用户需要找到红框标识的图标，然而该图标没有唯一定位的属性，推荐使用XPath语法描述该控件相对其他可定位控件的路径关系来定位该控件。
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.032.png)
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.033.png)
**示例代码**
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.034.png)
...
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.035.png)
用户可以通过 UiViewer 工具的控件查看模式获取控件的比例坐标。
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.036.png)
...
根据指定条件查找窗口，返回窗口对象。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.037.jpeg)
**点击图片可查看完整电子表格**
**返回值**
...
根据选定的控件或坐标位置执行点击操作。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.038.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.039.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
执行多指点击操作。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.040.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.041.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.042.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.043.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
在指定控件上执行双指捏合缩小操作。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.044.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
在指定控件上执行双指放大操作。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.045.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
执行双指滑动操作。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.046.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
执行自定义滑动手势操作。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.047.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
注入多指手势操作。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.048.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
执行鼠标点击操作, 支持键鼠组合操作。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.049.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.050.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.051.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
执行组合键操作，支持2键或3键组合。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.052.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
执行hdc命令。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.053.jpeg)
**点击图片可查看完整电子表格**
**返回值**
命令执行后的回显内容。
**使用示例**
...
在设备端shell中执行命令。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.054.jpeg)
**点击图片可查看完整电子表格**
**返回值**
命令执行后的回显内容。
**使用示例**
...
在PC端执行shell命令。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.055.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
安装指定应用安装包。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.056.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
卸载指定包名应用。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.057.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
清除应用的缓存数据。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.058.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
根据包名启动指定的应用。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.059.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
停止指定包名的应用。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.060.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
从设备端的传输文件到PC端。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.061.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
从PC端传输文件到设备端。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.062.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.063.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
向指定控件中输入文本内容。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.064.jpeg)
**点击图片可查看完整电子表格**
使用示例
...
清空指定控件中的文本内容。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.065.jpeg)
**点击图片可查看完整电子表格**
使用示例
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.066.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.067.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
检查指定控件在当前界面是否存在。
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.068.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.069.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.070.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
**参数说明**
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.071.jpeg)
**点击图片可查看完整电子表格**
**使用示例**
...
> 当前单个脚本 可以点击 插件图标，选择快速 调试此段函数

![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.072.png)
插件框架 会自动生成一个
- QuickRunMain.py
...
# -*- coding: utf-8 -*-
import sys
sys.path.append(r"E:\code\python\GAC_Hypium")
import io
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf8')
from hypium import *
if __name__ == '__main__':
    connector_server = ("127.0.0.1", 8710)
    config =  {"connector_server": ["127.0.0.1", "8710"]}
    driver = UiDriver.connect(connector="hdc", log_level="debug", device_sn="2MH0224521018321", config=config, connector_server=connector_server)
    from hypium import *
    from devicetest.core.test_case import TestCase, Step, CheckPoint

    driver.touch(BY.text("我的").type("Text"))
    driver.wait(0.5)
    driver.touch(BY.isAfter(BY.type('Image')).isBefore(BY.type('Refresh')).type('Image'))
    driver.wait(0.5)
    driver.touch(BY.isAfter(BY.text('个性化推荐')).isBefore(BY.text('调试')).type('Row'))
    driver.wait(0.5)
    driver.touch(BY.isAfter(BY.type('Image')).isBefore(BY.text('当前环境:')).type('Column'))
    driver.wait(0.5)
    driver.touch(BY.type('uat'))
    driver.wait(0.5)
    exist = driver.check_component_exist(BY.text("uat"))
    if exist:
        component_uat = driver.find_component(BY.text("uat"))
        component_uat.click()
        driver.stop_app(package_name="com.cloudy.component.hos", wait_time=3)
    else:
        print("查找uat 环境失败")
```

**常见问题**
**Xpath 定位不能同时使用其他 选择器**

```go
(<class 'ValueError'>, ValueError("xpath can't used with other attribute selector"), <traceback object at 0x0000019147D6D240>)
```

## 10. Xpath 定位失败

```json
(<class 'devicetest.core.exception.DeviceTestError'>, DeviceTestError("Can't find component with [/root/Column/Tabs/TabBar/Column[5]/Column/Text]"), <traceback object at 0x00000169C843AB80>)
```
...
```json
#自定义设置 =测试工程根目录 testcases 文件夹 / Ts_002文件夹  /Ts_002 当前JSON文件 同名的 Ts_002.py
"testsuite": "Ts_002/Ts_002",
```

- 若未指定，则默认查找与当前 JSON 文件同目录下同名的 Python文件
![...](/assets/images/harmony/鸿蒙-Hypium自动化（Python版本）.073.png)
11.2 **suitecases字段 要填对**

> 1. // 方式一：定义 suitecases 字段，并在其中指定测试用例脚本文件的路径。路径可使用相对路径或绝对路径；若使用相对路径，其根目录为当前测试套目录。

```json
[2026-05-09 15:35:42,725] [26444] [DeviceTest] [ERROR] [[Script-0203012] No test list found] [ErrorNo=00000]
[2026-05-09 15:35:42,726] [26444] [DeviceTest] [ERROR] [[Script-0203012] No test list found]
Traceback (most recent call last):
  File "F:\anaconda3\envs\py312\Lib\site-packages\devicetest\driver\device_test.py", line 126, in do_driver_execute
    test_list = driver_obj._get_test_list(json_config, request, source)
                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "F:\anaconda3\envs\py312\Lib\site-packages\devicetest\driver\device_test.py", line 400, in _get_test_list
    raise ParamError(err_msg)
_core.exception.ParamError: [Script-0203012] No test list found
```

```yaml
[2026-05-09 15:38:58,707] [30056] [DeviceTest] [ERROR] [[Environment-0101002] File path does not exist, path: Ts_002.pyc]
[2026-05-09 15:38:58,707] [30056] [DeviceTest] [ERROR] [[Script-0203012] No test list found] [ErrorNo=00000]
[2026-05-09 15:38:58,707] [30056] [DeviceTest] [ERROR] [[Script-0203012] No test list found]
Traceback (most recent call last):
  File "F:\anaconda3\envs\py312\Lib\site-packages\devicetest\driver\device_test.py", line 126, in do_driver_execute
    test_list = driver_obj._get_test_list(json_config, request, source)
                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
